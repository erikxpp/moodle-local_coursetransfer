...
$string['download_timeout'] = 'Timeout de descàrrega';
$string['download_timeout_desc'] = "Temps en segons d'espera per a la descàrrega d'arxius de backup (.mbz) entre origen i destinació. Recomanat: 300 segons (5 minuts) per a arxius grans.";
