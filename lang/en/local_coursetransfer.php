...
$string['download_timeout'] = 'Download timeout';
$string['download_timeout_desc'] = 'Waiting time in seconds for downloading backup files (.mbz) between source and target. Recommended: 300 seconds (5 minutes) for large files.';
