...
$string['download_timeout'] = 'Timeout de descarga';
$string['download_timeout_desc'] = 'Tiempo en segundos de espera para la descarga de archivos de backup (.mbz) entre origen y destino. Recomendado: 300 segundos (5 minutos) para archivos grandes.';
